...
public class PortalHelper {
     ...
     */
    public static boolean tryChangeDimention(Entity traveler, DimensionType destination, DivineTeleporter teleporter) {
        ...
        if (!traveler.world.isRemote && traveler.isAlive()) {
            ...
            teleporter.placePlayer(traveler);
            ...
            if (entity != null) {
                ...
                entity.moveToBlockPosAndAngles(entity.getPosition(), entity.rotationYaw + f, entity.rotationPitch);
