...
//        CustomTeleporterOld teleporter = destinationWorld.customTeleporters.stream()
//                .filter(x -> x instanceof CustomTeleporterOld)
//                .map(x -> ((CustomTeleporterOld) x))
//                // check correct world
//                .filter(x -> x.sameType(currentWorld, destinationWorld))
//                .findFirst().orElse(new CustomTeleporterOld(destinationWorld, currentWorld, description));
//
