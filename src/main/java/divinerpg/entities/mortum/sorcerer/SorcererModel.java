...
public class SorcererModel extends DivineModel<Sorcerer> {
    RendererModel body;
    RendererModel rightarm;
    RendererModel staffProngRight2;
    RendererModel rightleg;
    RendererModel leftleg;
    RendererModel leftarm;
    RendererModel staffPoleRight;
    RendererModel staffCapRight;
    RendererModel staffProngRight3;
    RendererModel staffProngRight1;
    RendererModel staffProngRight4;
    RendererModel head;
    RendererModel ray2;
    RendererModel ray8;
    RendererModel ray6;
    ...
    RendererModel ray5;
    RendererModel ray3;
    RendererModel staffPoleLeft;
    RendererModel staffCapLeft;
    RendererModel staffProngLeft1;
    RendererModel staffProngLeft2;
    RendererModel staffProngLeft4;
    RendererModel staffProngLeft3;

    public SorcererModel() {
        textureWidth = 64;
        textureHeight = 32;
        ...
        staffProngRight2 = new RendererModel(this, 40, 20);
        ...
        staffPoleRight = new RendererModel(this, 53, 0);
        ...
        staffCapRight = new RendererModel(this, 40, 25);
        ...
        staffProngRight3 = new RendererModel(this, 40, 20);
        ...
        staffProngRight1 = new RendererModel(this, 40, 20);
        ...
        staffProngRight4 = new RendererModel(this, 40, 20);
        ...
        staffPoleLeft = new RendererModel(this, 53, 0);
        ...
        staffCapLeft = new RendererModel(this, 40, 25);
        ...
        staffProngLeft1 = new RendererModel(this, 40, 20);
        ...
        staffProngLeft2 = new RendererModel(this, 40, 20);
        ...
        staffProngLeft4 = new RendererModel(this, 40, 20);
        ...
        staffProngLeft3 = new RendererModel(this, 40, 20);
    ...
    @Override
    public void setRotationAngles(Sorcerer entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor) {
        ...
        this.leftleg.rotateAngleX = this.rightarm.rotateAngleX = this.staffPoleRight.rotateAngleX = this.staffCapRight.rotateAngleX = this.staffProngRight1.rotateAngleX = this.staffProngRight2.rotateAngleX = this.staffProngRight3.rotateAngleX = this.staffProngRight4.rotateAngleX
                = MathHelper.cos(limbSwing) * limbSwingAmount * 1.2f;
        this.rightleg.rotateAngleX = this.leftarm.rotateAngleX = this.staffPoleLeft.rotateAngleX = this.staffCapLeft.rotateAngleX = this.staffProngLeft1.rotateAngleX = this.staffProngLeft2.rotateAngleX = this.staffProngLeft3.rotateAngleX = this.staffProngLeft4.rotateAngleX
                = MathHelper.cos(limbSwing + (float) Math.PI) * limbSwingAmount * 1.2f;
