...
public class AncientEntityModel extends DivineBossModel<DivineBoss> {
    ...
    public AncientEntityModel() {
        ...
        legR2B.func_228300_a_(-2F, 24F, -2F, 3, 9, 2);
        ...
        legL2T.func_228300_a_(-1F, 0F, -4F, 6, 12, 6);
        ...
        legR2T.func_228300_a_(-5F, 0F, -4F, 6, 12, 6);
        ...
        legR2M.func_228300_a_(-3F, 12F, -3F, 4, 12, 4);
        ...
        legL2M.func_228300_a_(-1F, 12F, -3F, 4, 12, 4);
        ...
        horntopl.func_228300_a_(0F, 0F, -12F, 1, 1, 12);
        ...
        hornbottomr.func_228300_a_(0F, 0F, -6F, 1, 1, 6);
        ...
        horntopr.func_228300_a_(0F, 0F, -12F, 1, 1, 12);
    ...
    public void render(MatrixStack stack, IVertexBuilder bufferIn, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float alpha) {
        DeobfHelper.translate(stack, 0, 0, 0.5);
