...
public class TwilightDemonModel extends DivineBossModel<DivineBoss> {
    ...
    public TwilightDemonModel() {
        ...
        this.head2 = new RendererModel(this, 32, 0);
        ...
        this.head3 = new RendererModel(this, 32, 0);
        ...
        this.connector1 = new RendererModel(this, 0, 20);
        ...
        this.connector2 = new RendererModel(this, 0, 20);
