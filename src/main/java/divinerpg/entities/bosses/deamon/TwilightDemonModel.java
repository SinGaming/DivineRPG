...
public class TwilightDemonModel extends DivineBossModel<DivineBoss> {
    ...
    public TwilightDemonModel() {
        ...
        this.connector1.func_228300_a_(0.0F, 0.0F, 0.0F, 4, 4, 6);
        ...
        this.connector2.func_228300_a_(-4.0F, 0.0F, 0.0F, 20, 4, 4);
    ...
    public void setRotationAngles(DivineBoss entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        this.head3.rotateAngleX = headPitch / (180F / (float) Math.PI);
