...
public class DensosModel extends DivineBossModel<DivineBoss> implements IHasArm {
    ...
    public DensosModel() {
        ...
        this.head.func_228300_a_(-11.0F, -8.0F, -4.0F, 8, 8, 8);
        ...
        this.rightarm.func_228300_a_(-3.0F, -2.0F, -2.0F, 4, 18, 4);
        this.rightarm.setRotationPoint(-5.0F, 2.0F, 0.0F);
        this.rightarm.setTextureSize(64, 32);
        this.rightarm.mirror = true;
        this.setRotation(this.rightarm, 0.0F, 0.0F, 0.0F);
        this.leftarm = new ModelRenderer(this, 40, 1);
        this.leftarm.func_228300_a_(-1.0F, -2.0F, -2.0F, 4, 18, 4);
        ...
        this.head2.func_228300_a_(0.0F, 0.0F, 0.0F, 8, 8, 8);
        ...
        this.head3.func_228300_a_(0.0F, 0.0F, 0.0F, 8, 8, 8);
        ...
        this.head4.func_228300_a_(0.0F, 0.0F, 0.0F, 8, 8, 8);
