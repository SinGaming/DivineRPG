...
public class VamacheronModel extends DivineBossModel<Vamacheron> {
    ...
    public VamacheronModel() {
        ...
        this.horn2.func_228300_a_(3.0F, -5.0F, -4.0F, 1, 3, 3);
        ...
        this.Horn.func_228300_a_(0.0F, 0.0F, 0.0F, 2, 7, 2);
        ...
        this.horn4.func_228300_a_(0.0F, 0.0F, 0.0F, 1, 3, 3);
        ...
        this.Horn1.func_228300_a_(0.0F, 0.0F, 0.0F, 2, 7, 2);
    ...
    @Override
    public void setRotationAngles(Vamacheron entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
