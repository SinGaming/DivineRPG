...
public class RollumModel extends DivineModel<Rollum> {
    ...
    public RollumModel() {
        ...
        connector.func_228300_a_(-4F, 0F, -2F, 4, 4, 4);
        ...
        leftarmext.func_228300_a_(0F, 9F, -10F, 4, 5, 9);
        ...
        rightarmext.func_228300_a_(-5F, 9F, -10F, 4, 5, 9);
    ...
    @Override
    public void setRotationAngles(Rollum entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
