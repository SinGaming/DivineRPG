...
public class RollumModel extends DivineModel<Rollum> {
    ...
    public RollumModel() {
        ...
        connector = new RendererModel(this, 30, 14);
        ...
        rightarmtop = new RendererModel(this, 36, 16);
        ...
        leftarmext = new RendererModel(this, 30, 18);
        ...
        rightarmext = new RendererModel(this, 30, 18);
