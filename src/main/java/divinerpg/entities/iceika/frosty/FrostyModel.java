...
public class FrostyModel extends DivineModel<Frosty> {
    ...
    RendererModel rightFinger3;
    RendererModel rightFinger2;
    RendererModel leftFinger2;
    RendererModel leftFinger3;
    ...
    public FrostyModel() {
        ...
        hatBase = new RendererModel(this, 105, 18);
        ...
        rightFinger1 = new RendererModel(this, 51, 0);
        ...
        leftArm = new RendererModel(this, 66, 0);
        ...
        rightFinger3 = new RendererModel(this, 51, 0);
        ...
        rightFinger2 = new RendererModel(this, 51, 0);
        ...
        leftFinger2 = new RendererModel(this, 51, 0);
        ...
        leftFinger3 = new RendererModel(this, 51, 0);
        ...
        leftFinger1 = new RendererModel(this, 51, 0);
    ...
    @Override
    public void render(Frosty entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
        GL11.glPushMatrix();
