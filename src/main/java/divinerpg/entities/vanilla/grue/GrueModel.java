...
public class GrueModel extends DivineModel<Grue> {
    RendererModel toeRightOut;
    RendererModel toeLeftOut;
    RendererModel toeRightIn;
    RendererModel toeLeftIn;
    RendererModel legRight;
    RendererModel legLeft;
    RendererModel thighRight;
    RendererModel thighLeft;
    RendererModel torso;
    RendererModel body;
    ...
    public GrueModel() {
        ...
        toeRightOut = new RendererModel(this, 0, 0);
        ...
        toeLeftOut = new RendererModel(this, 0, 0);
        ...
        toeRightIn = new RendererModel(this, 0, 0);
        ...
        toeLeftIn = new RendererModel(this, 0, 0);
        ...
        thighRight = new RendererModel(this, 0, 0);
        ...
        thighLeft = new RendererModel(this, 0, 0);
