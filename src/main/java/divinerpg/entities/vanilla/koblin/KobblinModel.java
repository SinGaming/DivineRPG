...
public class KobblinModel extends DivineModel<Kobblin> {
    ...
    public KobblinModel() {
        ...
        RArm2.func_228300_a_(-1.5F, 2F, 2.5F, 1, 4, 1);
        ...
        LArm1.func_228300_a_(0F, 0F, 0F, 1, 4, 1);
        ...
        LLeg.func_228300_a_(0F, 0F, 0F, 1, 4, 1);
    ...
    @Override
    public void setRotationAngles(Kobblin entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
