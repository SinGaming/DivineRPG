...
public class JackOManModel extends BipedModel<JackOMan> {
    ...
    @Override
    public void setRotationAngles(JackOMan entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor) {
