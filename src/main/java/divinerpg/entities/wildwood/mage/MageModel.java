...
public class MageModel extends DivineModel<Mage> {
    ...
    public MageModel() {
        ...
        rightarm.func_228300_a_(-6F, 4F, -2F, 4, 4, 4);
        ...
        staffProng3.func_228300_a_(1F, -7F, -3F, 1, 2, 1);
        ...
        staffProng1.func_228300_a_(4F, -7F, -6F, 1, 2, 1);
    ...
    @Override
    public void setRotationAngles(Mage entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
