...
public class CadilionModel extends DivineModel<DivineMonster> {
    ...
    public CadilionModel() {
        ...
        this.horn2.func_228300_a_(2.0F, -6.0F, -5.0F, 1, 3, 3);
        ...
        this.Horn.func_228300_a_(-1.0F, 3.0F, 2.0F, 2, 8, 2);
    ...
    @Override
    public void setRotationAngles(DivineMonster entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
