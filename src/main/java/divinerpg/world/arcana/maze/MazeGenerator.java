...
//    /**
//     * Creates brand new maze.
//     * 1 - for path, 0 - for walls
//     *
//     * @return
//     */
//    public static List<Cell> generateMap(int size) {
//        String[][] maze2D = maze2D(size);
//
//        Stack<Cell> location = new Stack<Cell>();
//        size = (maze2D.length - 1) / 2;
//        int totalCells = size * size;
//        int visitedCells = 1;
//        Cell current = new Cell(0, 0, maze2D);
//
...
//        }
//
//        System.out.println(convert2D(maze2D));
//
...
//     *
//     * @param maze2D The maze2D from after process through hashList method
//     * @return maze The string representation of the maze
//     */
